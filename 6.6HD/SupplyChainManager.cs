...
namespace SupplyChainHub
{
    public class SupplyChainManager
    {
        ...
        public void RegisterSupplier()
        {
            ...
            // Use the FactorySupplier to create the supplier, passing the CustomerManager
        ...
        public void AddWarehouse()
        {
            ...
            // Use Warehouse Factory to create Warehouse (no need to instantiate FactoryWarehouse)
