...
namespace SupplyChainHub
{
    public class CustomerManager
    {
        ...
        public void CancelOrder(Customer customer)
        {
            ...
            // Filter and display active orders for the customer, ensuring they are not canceled
            var activeOrders = _orders.Where(o => o.Customer == customer && o.OrderStatus != OrderStatus.Canceled).ToList();
            ...
            // Display each active order with its details
            ...
            var orderToCancel = activeOrders.FirstOrDefault(o => o.OrderID == orderId);
            ...
            // Call the CancelOrder method from the Order class (which will use the enum)
